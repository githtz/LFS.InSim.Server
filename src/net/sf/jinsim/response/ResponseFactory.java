...
/**
 * Used instead of the original ResponseFactory
 * Added support for ADMIN_COMMAND_REPORT responses
 * @author anrc
 * @version 1.0
 */
public class ResponseFactory {
	...
	private ResponseFactory() {
		...
		registeredTypes.put(PacketType.ADMIN_COMMAND_REPORT, AdminCommandReport.class);
	}
